...
export default function Votacion() {
  ...
  const guardarVotacion = async () => {
    ...
    try {
      ...
      if (!formulario.tema) {
        return alert("Ingrese un tema");
      }

      if (!formulario.reunion_id) {
        return alert("Seleccione una reunión");
      }

      const votosArray = Object.entries(votos).map(
        ([usuario_id, voto]) => ({
          usuario_id,
          voto,
        })
      ...
      <div className="flex-1 ml-64 p-8">
        ...
        <div className="mb-8">
          ...
          <p className="text-gray-500 mt-2">
            Registrar votaciones del consejo
          </p>
